...
if __name__ == "__main__":
    ...
    for k in range(snap_init, snap_final, 1):
        #subhalos_faceon, satellite_faceon = m12.subhalos_rotated(k) #DID NOT COMPILE
        ...
        if plot_type == "vr_mollweide":        
            ...
            # opl_sat, opb_sat = kin_sat.orbpole() # KIN_SAT NOT DEFINED
            # opl_ms, opb_ms = kin_ms.orbpole()    # KIN_MS NOT DEFINED
            # print(len(opl_ms))
